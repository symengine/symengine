...
TEST_CASE("Tan: functions", "[functions]")
{
    ...
    CHECK_THROWS_AS(tan(mul(integer(5), div(pi, i2))), SymEngineException);
}
...
TEST_CASE("Cot: functions", "[functions]")
{
    ...
    CHECK_THROWS_AS(cot(mul(integer(7), pi)), SymEngineException);
}
...
TEST_CASE("Csc: functions", "[functions]")
{
    ...
    CHECK_THROWS_AS(csc(mul(integer(7), pi)), SymEngineException);
    CHECK_THROWS_AS(csc(integer(0)), SymEngineException);
}
...
TEST_CASE("Sec: functions", "[functions]")
{
    ...
    CHECK_THROWS_AS(sec(mul(integer(7), div(pi, i2))), SymEngineException);
}
