...
TEST_CASE("Constructor of UnivariateIntPolynomial", "[UnivariateIntPolynomial]")
{
    ...
    RCP<const UnivariateIntPolynomial> P = univariate_int_polynomial(x, 2, {{0, 1}, {1, 2}, {2, 1}});
    REQUIRE(P->__str__() == "x**2 + 2*x + 1");

    RCP<const UnivariateIntPolynomial> Q = UnivariateIntPolynomial::create(x, {1, 0, 2, 1});
...
{
    RCP<const Symbol> x  = symbol("x");
    RCP<const UnivariateIntPolynomial> a = univariate_int_polynomial(x, 2, {{0, 1}, {1, 2}, {2, 1}});
    RCP<const UnivariateIntPolynomial> b = univariate_int_polynomial(x, 2, {{0, -1}, {1, -2}, {2, -1}});
...
{
    RCP<const Symbol> x  = symbol("x");
    RCP<const UnivariateIntPolynomial> z = univariate_int_polynomial(x, 0, {{0, 0}});
    RCP<const UnivariateIntPolynomial> o = univariate_int_polynomial(x, 0, {{0, 1}});
    RCP<const UnivariateIntPolynomial> mo = univariate_int_polynomial(x, 0, {{0, -1}});
    RCP<const UnivariateIntPolynomial> i = univariate_int_polynomial(x, 0, {{0, 6}});
    RCP<const UnivariateIntPolynomial> s = univariate_int_polynomial(x, 1, {{1, 1}});
    RCP<const UnivariateIntPolynomial> m1 = univariate_int_polynomial(x, 1, {{1, 6}});
    RCP<const UnivariateIntPolynomial> m2 = univariate_int_polynomial(x, 3, {{3, 5}});
    RCP<const UnivariateIntPolynomial> po = univariate_int_polynomial(x, 5, {{5, 1}});
    RCP<const UnivariateIntPolynomial> poly = univariate_int_polynomial(x, 2, {{0, 1}, {1, 2}, {2, 1}});
...
{
    RCP<const Symbol> x  = symbol("x");
    RCP<const UnivariateIntPolynomial> a = univariate_int_polynomial(x, 3, {{1, 1}, {2, 1}, {3, 1}});
