...
TEST_CASE("Constructor of UnivariateIntPolynomial", "[UnivariateIntPolynomial]")
{
    ...
    RCP<const UnivariateIntPolynomial> R = univariate_int_polynomial(none, {{0, 2_z}});
    REQUIRE(R->__str__() == "2");

    RCP<const UnivariateIntPolynomial> S = univariate_int_polynomial(none, std::map<unsigned int, integer_class>{});
    REQUIRE(S->__str__() == "0");
}
...
TEST_CASE("Derivative of UnivariateIntPolynomial", "[UnivariateIntPolynomial]")
{
    ...
    REQUIRE(a->diff(y)->__str__() == "0");
    a = univariate_int_polynomial(none, std::map<unsigned int, integer_class>{});
    REQUIRE(a->diff(y)->__str__() == "0");
}
...
TEST_CASE("Constructor of UnivariatePolynomial", "[UnivariatePolynomial]")
{
    ...
    RCP<const UnivariatePolynomial> T = univariate_polynomial(none, 0, std::map<int, Expression>{});
    REQUIRE(T->__str__() == "0");
}
