...
TEST_CASE("Adding two UnivariateIntPolynomial", "[UnivariateIntPolynomial]")
{
    ...
    UnivariateIntPolynomial q1(x, 2, {{2, 5_z}, {1, 5_z}, {0, 3_z}});
    REQUIRE(eq(*c, q1));
    ...
    UnivariateIntPolynomial q2(x, 2, {{2, 1_z}, {1, 2_z}, {0, 2_z}});
    REQUIRE(eq(*e, q2));
    UnivariateIntPolynomial q3(x, 2, {{2, 1_z}, {1, 2_z}, {0, 2_z}});
    REQUIRE(eq(*f, q3));
          ...
          "[UnivariateIntPolynomial]")
{
    ...
    REQUIRE(eq(*d, q1));
    d = sub_poly(c, a);
    UnivariateIntPolynomial q2(x, 2, {{2, -1_z}, {1, -2_z}, {0, 1_z}});
    REQUIRE(eq(*d, q2));
    d = sub_poly(a, c);
    UnivariateIntPolynomial q3(x, 2, {{2, 1_z}, {1, 2_z}, {0, -1_z}});
    REQUIRE(eq(*d, q3));
          ...
          "[UnivariateIntPolynomial]")
{
    ...
    UnivariateIntPolynomial q1(
        x, 4, {{4, 1_z}, {3, 4_z}, {2, 6_z}, {1, 4_z}, {0, 1_z}});
    REQUIRE(eq(*c, q1));
    UnivariateIntPolynomial q2(
        x, 4, {{4, -1_z}, {3, -4_z}, {2, -6_z}, {1, -4_z}, {0, -1_z}});
    REQUIRE(eq(*d, q2));
    UnivariateIntPolynomial q3(
        x, 4, {{4, 1_z}, {3, 4_z}, {2, -6_z}, {1, -20_z}, {0, 25_z}});
    REQUIRE(eq(*g, q3));
    UnivariateIntPolynomial q4(
        x, 4, {{4, -3_z}, {3, -4_z}, {2, 13_z}, {1, -22_z}, {0, 30_z}});
    REQUIRE(eq(*h, q4));
    UnivariateIntPolynomial q5(
        x, 4, {{4, 9_z}, {3, -12_z}, {2, 40_z}, {1, -24_z}, {0, 36_z}});
    REQUIRE(eq(*i, q5));
    UnivariateIntPolynomial q6(
        x, 4, {{4, -300_z}, {3, 194_z}, {2, -599_z}, {1, -10_z}, {0, -6_z}});
    REQUIRE(eq(*l, q6));
    UnivariateIntPolynomial q7(
        x, 4, {{4, 10000_z}, {3, 400_z}, {2, 204_z}, {1, 4_z}, {0, 1_z}});
    REQUIRE(eq(*m, q7));

    c = univariate_int_polynomial(none, {{0, -1_z}});
    UnivariateIntPolynomial q8(x, 2, {{2, -1_z}, {1, -2_z}, {0, -1_z}});
    REQUIRE(eq(*mul_poly(a, *c), q8));
    UnivariateIntPolynomial q9(x, 2, {{2, -1_z}, {1, -2_z}, {0, -1_z}});
