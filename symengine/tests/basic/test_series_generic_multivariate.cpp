...
TEST_CASE("Adding two MultivariateSeries", "[MultivariateSeries]")
{
    ...
    map_basic_uint m1 = {{x, 2}, {y, 3}};
    map_basic_uint m2 = {{y, 4}, {z, 2}};
    map_basic_uint m3 = {{x, 2}, {y, 3}, {z, 2}};
          ...
          "[Expansion of 1/ex]")
{
    ...
    std::cout << MultivariateSeries::series(ex5,"x",8)->__str__() <<std::endl;
