...
TEST_CASE("test_get_set(): matrices", "[matrices]")
{
    ...
    CHECK(eq(*A.get(0, 0), *integer(1)));
    CHECK(eq(*A.get(1, 1), *integer(-2)));

    A.set(1, 0, integer(0));
    CHECK(A == DenseMatrix(2, 2,
                           {integer(1), integer(0), integer(0), integer(-2)}));
    CHECK(A != DenseMatrix(2, 1, {integer(1), integer(-2)}));
    ...
    CHECK(eq(*B.get(0, 0), *integer(1)));
    CHECK(eq(*B.get(1, 2), *integer(3)));
    CHECK(eq(*B.get(2, 1), *integer(5)));

    B.set(2, 1, integer(6));
    CHECK(B == CSRMatrix(3, 3, {0, 2, 3, 6}, {0, 2, 2, 0, 1, 2},
                         {integer(1), integer(2), integer(3), integer(4),
                          integer(6), integer(6)}));

    B.set(0, 1, integer(1));
    CHECK(B == CSRMatrix(3, 3, {0, 3, 4, 7}, {0, 1, 2, 2, 0, 1, 2},
    ...
    CHECK(eq(*B.get(0, 0), *integer(0)));
    CHECK(eq(*B.get(1, 2), *integer(0)));
    CHECK(eq(*B.get(2, 2), *integer(0)));
    ...
    B.set(0, 0, integer(0));
    CHECK(B == CSRMatrix(3, 3, {0, 1, 2, 5}, {2, 2, 0, 1, 2},
                         {integer(2), integer(3), integer(4), integer(5),
                          integer(6)}));

    B.set(2, 1, integer(0));
    CHECK(B == CSRMatrix(3, 3, {0, 1, 2, 4}, {2, 2, 0, 2},
...
TEST_CASE("test_dense_dense_addition(): matrices", "[matrices]")
{
    ...
    CHECK(C == DenseMatrix(2, 2, {add(integer(1), symbol("c")),
    ...
    CHECK(C == DenseMatrix(1, 4, {add(integer(3), symbol("a")),
    ...
    CHECK(C == DenseMatrix(2, 3, {integer(17), integer(17), integer(2),
...
TEST_CASE("test_dense_dense_multiplication(): matrices", "[matrices]")
{
    ...
    CHECK(C == DenseMatrix(1, 1, {integer(8)}));
    ...
    CHECK(C == DenseMatrix(4, 3, {integer(110), integer(200), integer(120),
    ...
    CHECK(C == DenseMatrix(3, 1, {add(add(mul(symbol("a"), symbol("x")),
...
TEST_CASE("test_transpose_dense(): matrices", "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(3, 3, {symbol("a"), symbol("p"), symbol("u"),
...
TEST_CASE("test_submatrix_dense(): matrices", "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(3, 2, {symbol("b"), symbol("c"), symbol("q"),
    ...
    CHECK(B == DenseMatrix(3, 3, {integer(6), integer(7), integer(8),
...
TEST_CASE("test_pivoted_gaussian_elimination(): matrices", "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(2, 2, {integer(1), div(integer(3), integer(2)),
    ...
    CHECK(B == DenseMatrix(3, 3, {integer(1), integer(1), integer(1),
...
TEST_CASE("test_fraction_free_gaussian_elimination(): matrices", "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(2, 2, {symbol("a"), symbol("b"), integer(0),
    ...
    CHECK(B == DenseMatrix(
                   4, 4, {integer(8), integer(7), integer(4), integer(1),
    ...
    CHECK(B == DenseMatrix(3, 3, {integer(1), integer(2), integer(-1),
...
TEST_CASE("test_pivoted_gauss_jordan_elimination(): matrices", "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(3, 3, {integer(1), integer(0), integer(0),
                                  integer(0), integer(1), integer(0),
    ...
    CHECK(B == DenseMatrix(3, 2, {integer(1), integer(0), integer(0),
    ...
    CHECK(B == DenseMatrix(3, 3, {integer(1), integer(0), integer(1),
                                  integer(0), integer(1), integer(0),
                                  integer(0), integer(0), integer(0)}));
          ...
          "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(
                   4, 4, {integer(-139), integer(0), integer(0), integer(0),
          ...
          "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(3, 3, {integer(6), integer(0), integer(0),
          ...
          "[matrices]")
{
    ...
    CHECK(x == DenseMatrix(2, 1, {integer(4), integer(1)}));
    ...
    CHECK(x == DenseMatrix(2, 1, {integer(1), integer(1)}));
    ...
    CHECK(x == DenseMatrix(2, 1, {integer(3), integer(2)}));
    ...
    // CHECK(x == DenseMatrix(2, 1, {symbol("a"), symbol("b")}));
...
TEST_CASE("test_LU(): matrices", "[matrices]")
{
    ...
    CHECK(L == DenseMatrix(3, 3, {integer(1), integer(0), integer(0),
                                  integer(2), integer(1), integer(0),
                                  integer(8), integer(21), integer(1)}));
    CHECK(U == DenseMatrix(3, 3, {integer(1), integer(3), integer(5),
...
TEST_CASE("test_pivoted_LU(): matrices", "[matrices]")
{
    ...
    CHECK(pl == permutelist({{1, 0}, {2, 1}}));

    CHECK(L == DenseMatrix(3, 3, {integer(1), integer(0), integer(0),
                                  integer(4), integer(1), integer(0),
                                  integer(0), integer(0), integer(1)}));
    CHECK(U == DenseMatrix(3, 3, {integer(2), integer(6), integer(6),
...
TEST_CASE("test_fraction_free_LDU(): matrices", "[matrices]")
{
    ...
    CHECK(D == DenseMatrix(3, 3, {integer(1), integer(0), integer(0),
                                  integer(0), integer(-13), integer(0),
                                  integer(0), integer(0), integer(-13)}));
    CHECK(U == DenseMatrix(3, 3, {integer(1), integer(2), integer(3),
    ...
    CHECK(L == DenseMatrix(3, 3, {integer(5), integer(0), integer(0),
                                  integer(-1), integer(23), integer(0),
                                  integer(-10), integer(20), integer(1)}));
    CHECK(D == DenseMatrix(3, 3, {integer(5), integer(0), integer(0),
                                  integer(0), integer(115), integer(0),
                                  integer(0), integer(0), integer(23)}));
    CHECK(U == DenseMatrix(3, 3, {integer(5), integer(3), integer(1),
...
TEST_CASE("test_LDL(): matrices", "[matrices]")
{
    ...
    CHECK(D == DenseMatrix(3, 3, {integer(4), integer(0), integer(0),
                                  integer(0), integer(1), integer(0),
    ...
    CHECK(D == DenseMatrix(3, 3, {integer(25), integer(0), integer(0),
...
TEST_CASE("test_determinant(): matrices", "[matrices]")
{
    ...
    CHECK(eq(*det_bareis(M), *integer(1)));
    CHECK(eq(*det_berkowitz(M), *integer(1)));
    ...
    CHECK(eq(*det_bareis(M), *integer(-289)));
    CHECK(eq(*det_berkowitz(M), *integer(-289)));

    M = DenseMatrix(4, 4, {integer(1), integer(2), integer(3), integer(4),
                           integer(5), integer(6), integer(7), integer(8),
                           integer(9), integer(10), integer(11), integer(12),
                           integer(13), integer(14), integer(15), integer(16)});
    CHECK(eq(*det_bareis(M), *integer(0)));
    CHECK(eq(*det_berkowitz(M), *integer(0)));
    ...
    CHECK(eq(*det_bareis(M), *integer(275)));
    CHECK(eq(*det_berkowitz(M), *integer(275)));
    ...
    CHECK(eq(*det_bareis(M), *integer(-55)));
    CHECK(eq(*det_berkowitz(M), *integer(-55)));
    ...
    CHECK(eq(*det_bareis(M), *integer(11664)));
    CHECK(eq(*det_berkowitz(M), *integer(11664)));
    ...
    CHECK(eq(*det_bareis(M), *integer(123)));
    CHECK(eq(*det_berkowitz(M), *integer(123)));
}
...
TEST_CASE("test_berkowitz(): matrices", "[matrices]")
{
    ...
    CHECK(polys[1] == DenseMatrix(3, 1, {integer(1), integer(-2), integer(1)}));
    CHECK(polys[0] == DenseMatrix(2, 1, {integer(1), integer(-1)}));
    ...
    CHECK(polys[1] == DenseMatrix(3, 1, {integer(1), mul(integer(-1), x),
                                         mul(integer(-1), y)}));
    CHECK(polys[0] == DenseMatrix(2, 1, {integer(1), mul(integer(-1), x)}));
    ...
    CHECK(polys[2] == DenseMatrix(4, 1, {integer(1), integer(-9), integer(9),
                                         integer(-1)}));
    CHECK(polys[1] == DenseMatrix(3, 1, {integer(1), integer(-3), integer(1)}));
    CHECK(polys[0] == DenseMatrix(2, 1, {integer(1), integer(-1)}));
}
...
TEST_CASE("test_solve_functions(): matrices", "[matrices]")
{
    ...
    CHECK(x == DenseMatrix(2, 1, {integer(2), integer(7)}));
}
...
TEST_CASE("test_char_poly(): matrices", "[matrices]")
{
    ...
    CHECK(B == DenseMatrix(3, 1, {integer(1), integer(-1), integer(-6)}));

    A = DenseMatrix(2, 2, {integer(2), integer(1), integer(-1), integer(0)});
    B = DenseMatrix(3, 1);
    char_poly(A, B);

    CHECK(B == DenseMatrix(3, 1, {integer(1), integer(-2), integer(1)}));
...
TEST_CASE("test_csr_has_canonical_format(): matrices", "[matrices]")
{
    ...
    CHECK(CSRMatrix::csr_has_canonical_format(p, j, 3) == false);
...
TEST_CASE("test_csr_diagonal(): matrices", "[matrices]")
{
    ...
    CHECK(D == DenseMatrix(3, 1, {integer(1), integer(0), integer(6)}));
}
...
TEST_CASE("test_csr_scale_rows(): matrices", "[matrices]")
{
    ...
    CHECK(A == CSRMatrix(3, 3, {0, 2, 3, 6}, {0, 2, 2, 0, 1, 2},
...
TEST_CASE("test_eye(): matrices", "[matrices]")
{
    ...
    CHECK(A == DenseMatrix(3, 3, {integer(1), integer(0), integer(0),
                                  integer(0), integer(1), integer(0),
                                  integer(0), integer(0), integer(1)}));

    eye(A, 1);
    CHECK(A == DenseMatrix(3, 3, {integer(0), integer(1), integer(0),
                                  integer(0), integer(0), integer(1),
                                  integer(0), integer(0), integer(0)}));

    eye(A, -1);
    CHECK(A == DenseMatrix(3, 3, {integer(0), integer(0), integer(0),
                                  integer(1), integer(0), integer(0),
                                  integer(0), integer(1), integer(0)}));
...
TEST_CASE("test_diag(): matrices", "[matrices]")
{
    ...
    diag(A, d, -2);
    CHECK(A
          == DenseMatrix(5, 5, {integer(0), integer(0), integer(0), integer(0),
                                integer(0), integer(0), integer(0), integer(0),
                                integer(0), integer(0), integer(1), integer(0),
                                integer(0), integer(0), integer(0), integer(0),
...
TEST_CASE("test_ones_zeros(): matrices", "[matrices]")
{
    ...
    CHECK(A == DenseMatrix(1, 5, {integer(1), integer(1), integer(1),
                                  integer(1), integer(1)}));

    A = DenseMatrix(2, 3);
    ones(A);
    CHECK(A == DenseMatrix(2, 3, {integer(1), integer(1), integer(1),
                                  integer(1), integer(1), integer(1)}));

    A = DenseMatrix(3, 2);
    zeros(A);
    CHECK(A == DenseMatrix(3, 2, {integer(0), integer(0), integer(0),
                                  integer(0), integer(0), integer(0)}));
}
...
TEST_CASE("Test Jacobian", "[matrices]")
{
    ...
    J = DenseMatrix(4, 4);
    jacobian(A, X, J);
    CHECK(J == DenseMatrix(4, 4, {integer(1), integer(0), integer(1),
    ...
    J = DenseMatrix(4, 3);
    jacobian(A, X, J);
    CHECK(J == DenseMatrix(4, 3, {integer(1), integer(0), integer(1),
    ...
    J = DenseMatrix(2, 2);
    sjacobian(A, X, J);
    CHECK(J == DenseMatrix(2, 2, {y, f, integer(0), mul(integer(2), y)}));
}
...
TEST_CASE("Test Diff", "[matrices]")
{
    ...
    J = DenseMatrix(2, 2);
    diff(A, x, J);
    CHECK(J == DenseMatrix(2, 2, {integer(1), integer(0), z, integer(1)}));

    A = DenseMatrix(
        2, 2, {add(f, z), mul(f, x), add(mul(z, f), add(y, t)), add(f, y)});
    sdiff(A, f, J);
    CHECK(J == DenseMatrix(2, 2, {integer(1), x, z, integer(1)}));
}
