...
private:
    ...
    // UnivariateIntPolynomial x**2 + 2*x + 1 has dict_ = {{0, 1}, {1,
    // 2}, {2,
    // 1}} with var_ = "x"
...
public:
    ...
    // create a UnivariateIntPolynomial from a dense vector of
    // integer_class
    // coefficients
    static RCP<const UnivariateIntPolynomial>
...
public:
    ...
    * Mul, Pow, UnivariatePolynomial) depending on the size of
    * dictionary `d`.
    */
