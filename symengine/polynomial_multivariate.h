...
public:
    ...
    static RCP<const MultivariateIntPolynomial> convert(const UIntPolyO &o);
};
...
public:
    ...
    static RCP<const MultivariatePolynomial> convert(const UExprPolyO &o);
};
...
template <>
struct is_mpoly_expr<UExprPolyO> : std::true_type {
};
...
template <>
struct is_mpoly_int<UIntPolyO> : std::true_type {
};
