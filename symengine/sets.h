...
class Set : public Basic {
    public:
        ...
        virtual RCP<const Set> _intersection(const RCP<const Set> &o) const = 0;
        virtual RCP<const Set> _union(const RCP<const Set> &o) const = 0;
...
class EmptySet : public Set {
    ...
    public:
        ...
        virtual RCP<const Set> _intersection(const RCP<const Set> &o) const;
        virtual RCP<const Set> _union(const RCP<const Set> &o) const;
