...
public:
    ...
    // Below methods should be implemented by the derived classes. If
    // not
...
// Characteristic polynomial: Only the coefficients of monomials in
// decreasing
// order of monomial powers is returned, i.e. if `B = transpose([1, -2,
// 3])`
