/* Generated by re2c 1.1.1 on Thu Aug  1 11:38:29 2019 */
#line 1 "tokenizer.re"
#include <float.h>
#include <limits.h>
#include <stdio.h>
...
#line 135 "tokenizer.re"
	{ continue; }
#line 209 "tokenizer.cpp"
yy9:
	++in->cur;
yy10:
#line 137 "tokenizer.re"
	{ return in->tok[0]; }
#line 215 "tokenizer.cpp"
yy11:
	yych = *++in->cur;
	if (yych == '*') goto yy19;
	goto yy10;
...
#line 139 "tokenizer.re"
	{ return Parser::LE; }
#line 413 "tokenizer.cpp"
yy33:
	++in->cur;
#line 141 "tokenizer.re"
	{ return Parser::EQ; }
#line 418 "tokenizer.cpp"
yy35:
	++in->cur;
#line 140 "tokenizer.re"
	{ return Parser::GE; }
#line 423 "tokenizer.cpp"
yy37:
	yych = *++in->cur;
	if (yych <= '/') goto yy38;
	if (yych <= '9') goto yy39;
