...
#line 160 "parser.tab.cc" /* yacc.c:359  */
...
static const char *const yytname[] =
{
  ...
  "'+'", "'*'", "'/'", "POW", "'('", "')'", "$accept", "st_expr", "expr", YY_NULLPTR
};
#endif
