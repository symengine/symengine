...
PI__ const s_productionInfo[] = {
    ...
    {272, 3}, // 6: expr (POW) ->  expr POW expr
    {272, 3}, // 7: expr ('<') ->  expr '<' expr
    {272, 3}, // 8: expr ('>') ->  expr '>' expr
    {272, 3}, // 9: expr (LE) ->  expr LE expr
    {272, 3}, // 10: expr (GE) ->  expr GE expr
    {272, 3}, // 11: expr (EQ) ->  expr EQ expr
    {272, 3}, // 12: expr ('|') ->  expr '|' expr
    {272, 3}, // 13: expr ('&') ->  expr '&' expr
    {272, 3}, // 14: expr ('^') ->  expr '^' expr
    {272, 3}, // 15: expr ('(') ->  '(' expr ')'
    {272, 2}, // 16: expr (UMINUS) ->  '-' expr
    {272, 2}, // 17: expr (NOT) ->  '~' expr
    {272, 1}, // 18: expr ->  leaf
    {273, 1}, // 19: leaf (IDENTIFIER) ->  IDENTIFIER
    {273, 1}, // 20: leaf (IMPLICIT_MUL) ->  IMPLICIT_MUL
    {273, 1}, // 21: leaf (NUMERIC) ->  NUMERIC
    {273, 1}, // 22: leaf ->  func
    {274, 4}, // 23: func (IDENTIFIER) ->  IDENTIFIER '(' expr_list ')'
    {275, 3}, // 24: expr_list (',') ->  expr_list ',' expr
    {275, 1}, // 25: expr_list ->  expr
    {276, 1}, // 26: st_expr_$ ->  st_expr
};
...
SR__ *s_state[] = {
    ...
    s_36, s_37, s_38, s_39, s_40, s_41, s_42, s_43, s_44, s_45, s_46,
};
