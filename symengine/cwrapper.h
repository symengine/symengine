...
basic_code_printer_settings_free(BasicCodePrinterSettings *self);
//! Set the precision in the code printer settings
SYMENGINE_EXPORT void
basic_code_printer_settings_set_precision(BasicCodePrinterSettings *self,
