...
//! Returns the class name of with the typeid `id`, caller is responsible to
//! free the string with 'basic_str_free'
...
//! Return a string representation of s, caller is responsible to free
//! the string with 'basic_str_free'
...
CWRAPPER_OUTPUT_TYPE function_symbol_set(basic s, const char *c,
                                         const CVecBasic *arg);
//! Returns the name of the given FunctionSymbol, caller is responsible to free
//! the string with 'basic_str_free'
