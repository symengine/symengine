...
void cancel(const RCP<const Basic> &self, const RCP<const Basic> &other,
  const Ptr<RCP<const UIntPolyFlint>> &result_self, const Ptr<RCP<const UIntPolyFlint>> &result_other)
{
  ...
  RCP<const UIntPolyFlint> self_poly = from_basic<UIntPolyFlint>(self, self_var);
  RCP<const UIntPolyFlint> other_poly = from_basic<UIntPolyFlint>(other, other_var);
