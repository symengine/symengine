...
void test_from_coo()
{
    ...
    CSRMatrix A = CSRMatrix(3, 3, 6, {0, 2, 3, 6}, {0, 2, 2, 0, 1, 2},
        {integer(1), integer(2), integer(3), integer(4), integer(5), integer(6)});
    CSRMatrix B = from_coo(3, 3, 6, {0, 0, 1, 2, 2, 2}, {0, 2, 2, 0, 1, 2},
        {integer(1), integer(2), integer(3), integer(4), integer(5), integer(6)});

    assert(A == B);

    A = CSRMatrix(4, 6, 8, {0, 2, 4, 7, 8}, {0, 1, 1, 3, 2, 3, 4, 5},
        {integer(10), integer(20), integer(30), integer(40), integer(50),
        integer(60), integer(70), integer(80)});
    B = from_coo(4, 6, 8, {0, 0, 1, 1, 2, 2, 2, 3}, {0, 1, 1, 3, 2, 3, 4, 5},
        {integer(10), integer(20), integer(30), integer(40), integer(50),
        integer(60), integer(70), integer(80)});
