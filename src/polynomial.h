...
namespace CSymPy {
    ...
    //    void add(const RCP<const polynomial> &b, const RCP<const polynomial> &c){
        ...
        Polynomial(const std::string& var, map_integer_uint&& dict) : degree{-1}, var_{var}, dict_{move(dict)} {}
...
virtual void accept(Visitor &v) const;
    ...
    inline RCP<const Polynomial> polynomial(std::string i)
{
    return rcp(new Polynomial(i));
}
}
